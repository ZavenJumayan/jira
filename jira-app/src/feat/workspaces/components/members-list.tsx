...
import {useDeleteMember} from "@/feat/members/api/use-delete-member";
import {useUpdateMember} from "@/feat/members/api/use-update-member";
...
export const MembersList = () => {
    ...
    return (
        <Card className="w-full h-full  border-none shadow-none ">
            <ConfirmDialog/>
            <CardHeader className="flex flex-row item-center gap-x-4 p-7 space-y-0">
